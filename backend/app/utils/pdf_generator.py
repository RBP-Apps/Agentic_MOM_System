...
# Register DejaVu Sans for Unicode support (Rupee ₹, etc.)
...
def draw_header_footer(canvas, doc):
    ...
    if os.path.exists(LOGO_PATH):
        try:
            ...
            canvas.setFont("DejaVuSans-Bold", 24)
    ...
    addr_style = ParagraphStyle('AddrStyle', fontName='DejaVuSans', fontSize=9, textColor=colors.HexColor("#4f46e5"), leading=11, alignment=TA_RIGHT)
...
def generate_any_pdf(title: str, subtitle: str, content: str) -> bytes:
    ...
    h1 = ParagraphStyle('H1', parent=styles['Heading1'], fontName='DejaVuSans-Bold', fontSize=14, textColor=colors.HexColor("#1e293b"), spaceAfter=12)
    h2 = ParagraphStyle('H2', parent=styles['Heading2'], fontName='DejaVuSans-Bold', fontSize=11, textColor=colors.HexColor("#334155"), spaceAfter=8, spaceBefore=12)
    body = ParagraphStyle('Body', parent=styles['Normal'], fontName='DejaVuSans', fontSize=10, textColor=colors.HexColor("#475569"), leading=14, spaceAfter=6)
...
def generate_transcript_pdf(title: str, date: str, transcript_text: str) -> bytes:
    ...
    title_style = ParagraphStyle('TTitle', parent=styles['Heading1'], fontName='DejaVuSans-Bold', fontSize=16, textColor=colors.HexColor("#1e1b4b"), spaceAfter=4)
    meta_style = ParagraphStyle('TMeta', parent=styles['Normal'], fontName='DejaVuSans', fontSize=9, textColor=colors.HexColor("#64748b"), spaceAfter=2)
    ...
    line_num_style = ParagraphStyle('TLineNum', parent=styles['Normal'], fontName='DejaVuSans', fontSize=7, textColor=colors.HexColor("#94a3b8"), leading=14, spaceAfter=4)
...
def generate_audit_log_pdf(title: str, date: str, chunk_summaries: list) -> bytes:
    ...
    sec_title = ParagraphStyle('ASecTitle', parent=styles['Heading2'], fontName='DejaVuSans-Bold', fontSize=11, textColor=colors.HexColor("#1e1b4b"), spaceAfter=4, spaceBefore=16)
    meta_style = ParagraphStyle('AMeta', parent=styles['Normal'], fontName='DejaVuSans', fontSize=9, textColor=colors.HexColor("#64748b"), spaceAfter=2)
    body_style = ParagraphStyle('ABody', parent=styles['Normal'], fontName='DejaVuSans', fontSize=9, textColor=colors.HexColor("#334155"), leading=13, spaceAfter=4, leftIndent=8)
    chunk_label = ParagraphStyle('AChunk', parent=styles['Normal'], fontName='DejaVuSans-Bold', fontSize=10, textColor=colors.HexColor("#4f46e5"), spaceAfter=2, spaceBefore=14)
...
def generate_summary_pdf(title: str, date: str, summary_text: str) -> bytes:
    ...
    h1 = ParagraphStyle('SH1', parent=styles['Heading1'], fontName='DejaVuSans-Bold', fontSize=15, textColor=colors.HexColor("#1e1b4b"), spaceAfter=6)
    h2 = ParagraphStyle('SH2', parent=styles['Heading2'], fontName='DejaVuSans-Bold', fontSize=11, textColor=colors.HexColor("#4338ca"), spaceAfter=6, spaceBefore=14)
    meta = ParagraphStyle('SMeta', parent=styles['Normal'], fontName='DejaVuSans', fontSize=9, textColor=colors.HexColor("#64748b"), spaceAfter=2)
    body = ParagraphStyle('SBody', parent=styles['Normal'], fontName='DejaVuSans', fontSize=10, textColor=colors.HexColor("#1e293b"), leading=15, spaceAfter=8)
