      ...
      <div className="bg-white dark:bg-[#161b27] rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden">
        <div className="flex items-center justify-between px-5 py-3 border-b border-slate-100 dark:border-slate-800 bg-slate-50/30 dark:bg-white/5">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[12px] font-bold text-slate-700 dark:text-slate-300 uppercase tracking-widest">Task Intelligence Summary</span>
          </div>
          <Link to="/tasks?source=Regular" className="text-[11px] font-bold text-brand-600 dark:text-brand-400 hover:underline flex items-center gap-1">
                ...
                <div className="flex items-start gap-4 min-w-0">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      >
                        <span className="text-brand-500 font-mono text-[13px] mr-1.5 opacity-70">MOM-{String(m.id).padStart(3, '0')}</span>
                        {m.title}
                      </Link>
